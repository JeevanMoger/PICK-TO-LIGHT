...
void can_transmit(void)
{
 ...
 TXB0DLC = 0x08;
# 114 "can.c"
    TXB0D0 = read_internal_eeprom(0X00);
    TXB0D1 = read_internal_eeprom(0X01);
    TXB0D2 = read_internal_eeprom(0X02);
    TXB0D3 = read_internal_eeprom(0X03);
    TXB0D4 = read_internal_eeprom(0X04);
    TXB0D5 = read_internal_eeprom(0X05);
    TXB0D6 = read_internal_eeprom(0X06);
    TXB0D7 = read_internal_eeprom(0X07);
 TXB0REQ = 1;
