...
void receive_can_data() {
    if (can_receive()) {
        num = 0;
        num = can_payload[5 + 0] - 48;
        num = (num * 10) + (can_payload[5 + 1] - 48);
        num = (num * 10) + (can_payload[5 + 2] - 48);
        num = (num * 10) + (can_payload[5 + 3] - 48);

        can_id[0] = can_payload[5 + 4];
        can_id[1] = can_payload[5 + 5];
        can_id[2] = can_payload[5 + 6];
        can_id[3] = can_payload[5 + 7];
        can_id[4] = '\0';
