...
void receive_can(void) {
    if (can_receive()) {
        arr_st[0] = can_payload[5 + 0];
        arr_st[1] = can_payload[5 + 1];
        arr_st[2] = can_payload[5 + 2];
        arr_st[3] = can_payload[5 + 3];
        arr_st[4] = '\0';
        arr_id[0] = can_payload[5 + 4];
        arr_id[1] = can_payload[5 + 5];
        arr_id[2] = can_payload[5 + 6];
        arr_id[3] = can_payload[5 + 7];
        arr_id[4] = '\0';
        puts("\n\r\n\rRECIEVED DATA ->   \n\rPRODUCT ID: ");
        puts(arr_id);
        puts("\n\rUPDATED STOCK: ");
